...
var I18N_MAP = {
  ...
  'en': {
    ...
    price_expand: 'Open settings',
    price_collapse: 'Close settings',
    price_loading_full: 'Loading full prices...',
    model_label: 'Model',
  ...
  'ru': {
    ...
    price_expand: 'Открыть настройки',
    price_collapse: 'Скрыть настройки',
    price_loading_full: 'Загрузка всех цен...',
    model_label: 'Модель',
