...
var I18N_MAP = {
  'zh-CN': {
    ...
    price_reference_title: '模型价格查询',
    price_reference_subtle: '输入模型名筛选当前价格表，选择后查看输入、输出和缓存价格；此处不会修改设置。',
    price_reference_label: '查询模型',
    price_reference_select: '选择模型查看价格',
    price_reference_search_placeholder: '输入模型名或 provider/model 搜索',
    price_reference_empty: '请选择模型查看价格信息。',
    price_reference_none: '当前没有可查询的模型价格。',
    price_reference_no_match: '没有匹配的模型，请调整搜索内容。',
    price_reference_result_limit: '显示前 {0} 项（共 {1} 项），请继续输入缩小范围。',
    price_reference_missing: '未找到该模型的有效价格。',
    price_source_manual: '手动设置',
    price_source_default: '价格源',
    price_match_key: '匹配 {0}',
    ...
    input_model_placeholder: '输入或选择 provider/modelname；裸模型名可手动输入',
    ...
    storage_error: '持久化异常',
    storage_database_path: 'SQLite 数据库',
    storage_event_count: '事件数量',
    storage_database_size: '数据库大小',
    storage_last_write: '最后写入',
    storage_dropped_events: '丢弃事件',
    ...
    events_page: '显示 {0}-{1}，共 {2} 条（第 {3}/{4} 页）',
    ...
    distribution_title: '用量分布',
    distribution_subtle: '按 Token 查看模型、上游接口、端点和分项趋势。',
    distribution_token_mode: '按 Token',
    model_distribution_title: '模型分布',
    upstream_distribution_title: '上游接口使用分布',
    endpoint_distribution_title: '端点分布',
    ...
    token_distribution_title: 'Token 使用趋势',
    token_distribution_subtle: '输入、输出与缓存分项',
    token_input: '输入',
    token_output: '输出',
  ...
  'zh-TW': {
    ...
    price_reference_title: '模型價格查詢',
    price_reference_subtle: '輸入模型名稱篩選目前價格表，選取後查看輸入、輸出與快取價格；此處不會修改設定。',
    price_reference_label: '查詢模型',
    price_reference_select: '選擇模型查看價格',
    price_reference_search_placeholder: '輸入模型名稱或 provider/model 搜尋',
    price_reference_empty: '請選擇模型查看價格資訊。',
    price_reference_none: '目前沒有可查詢的模型價格。',
    price_reference_no_match: '沒有符合的模型，請調整搜尋內容。',
    price_reference_result_limit: '顯示前 {0} 項（共 {1} 項），請繼續輸入以縮小範圍。',
    price_reference_missing: '找不到該模型的有效價格。',
    price_source_manual: '手動設定',
    price_source_default: '價格來源',
    price_match_key: '符合 {0}',
    ...
    input_model_placeholder: '輸入或選取 provider/modelname；裸模型名稱可手動輸入',
    ...
    storage_error: '持久化異常',
    storage_database_path: 'SQLite 資料庫',
    storage_event_count: '事件數量',
    storage_database_size: '資料庫大小',
    storage_last_write: '最後寫入',
    storage_dropped_events: '丟棄事件',
    ...
    events_page: '顯示 {0}-{1}，共 {2} 條（第 {3}/{4} 頁）',
    ...
    unknown_model: '未知模型',
    unknown_endpoint: '未知端點',
    token_distribution_title: 'Token 使用趨勢',
    token_distribution_subtle: '輸入、輸出與快取分項',
    token_input: '輸入',
    token_output: '輸出',
  ...
  'en': {
    ...
    price_reference_title: 'Model Price Lookup',
    price_reference_subtle: 'Search the current price table by model name, then select a result to view input, output and cache prices. This is read-only.',
    price_reference_label: 'Lookup model',
    price_reference_select: 'Choose a model to view prices',
    price_reference_search_placeholder: 'Search model or provider/model',
    price_reference_empty: 'Choose a model to view price information.',
    price_reference_none: 'No model prices are available to look up.',
    price_reference_no_match: 'No models match this search.',
    price_reference_result_limit: 'Showing the first {0} of {1}; keep typing to narrow the results.',
    price_reference_missing: 'No effective price was found for this model.',
    price_source_manual: 'Manual setting',
    price_source_default: 'Price source',
    price_match_key: 'matched {0}',
    ...
    input_model_placeholder: 'Enter or choose provider/modelname; bare names can be typed',
    ...
    storage_database_path: 'SQLite database',
    storage_event_count: 'Events',
    storage_database_size: 'Database size',
    storage_last_write: 'Last write',
    storage_dropped_events: 'Dropped events',
    ...
    events_page: 'Showing {0}-{1} of {2} (page {3}/{4})',
    ...
    distribution_title: 'Usage Distribution',
    distribution_subtle: 'View model, upstream API, endpoint, and token-part trends by token.',
    distribution_token_mode: 'By Token',
    model_distribution_title: 'Model Distribution',
    upstream_distribution_title: 'Upstream API Usage Distribution',
    endpoint_distribution_title: 'Endpoint Distribution',
    ...
    token_distribution_title: 'Token Usage Trend',
    token_distribution_subtle: 'Input, output, and cache parts',
    token_input: 'Input',
    token_output: 'Output',
  ...
  'ru': {
    ...
    price_reference_title: 'Просмотр цен моделей',
    price_reference_subtle: 'Введите имя модели для поиска в текущей таблице цен, затем выберите результат для просмотра цен ввода, вывода и кэша. Изменения здесь не вносятся.',
    price_reference_label: 'Модель для просмотра',
    price_reference_select: 'Выберите модель для просмотра цен',
    price_reference_search_placeholder: 'Поиск модели или provider/model',
    price_reference_empty: 'Выберите модель, чтобы увидеть информацию о цене.',
    price_reference_none: 'Нет доступных цен моделей для просмотра.',
    price_reference_no_match: 'Модели по этому запросу не найдены.',
    price_reference_result_limit: 'Показаны первые {0} из {1}; продолжайте ввод, чтобы сузить список.',
    price_reference_missing: 'Действующая цена для этой модели не найдена.',
    price_source_manual: 'Ручная настройка',
    price_source_default: 'Источник цен',
    price_match_key: 'совпадение {0}',
    ...
    input_model_placeholder: 'Введите или выберите provider/modelname; короткое имя вводится вручную',
    ...
    storage_database_path: 'База SQLite',
    storage_event_count: 'События',
    storage_database_size: 'Размер базы',
    storage_last_write: 'Последняя запись',
    storage_dropped_events: 'Отброшенные события',
    ...
    events_page: 'Показано {0}-{1} из {2} (страница {3}/{4})',
    ...
    distribution_title: 'Распределение использования',
    distribution_subtle: 'Модели, upstream API, эндпоинты и части токенов.',
    distribution_token_mode: 'По токенам',
    model_distribution_title: 'Распределение моделей',
    upstream_distribution_title: 'Распределение использования upstream API',
    endpoint_distribution_title: 'Распределение эндпоинтов',
    ...
    token_distribution_title: 'Тренд использования токенов',
    token_distribution_subtle: 'Ввод, вывод и кэш',
    token_input: 'Ввод',
    token_output: 'Вывод',
